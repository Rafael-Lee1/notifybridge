...
const MessageFlow: React.FC<MessageFlowProps> = ({ isActive, className, messageCount }) => {
  return (
    <div className={cn("w-full h-20 relative", className)}>
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {messageCount > 0 && (
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-5 bg-primary text-white text-xs font-medium px-2 py-1 rounded-full"
          >
            {messageCount}
          </motion.div>
        )}
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col items-center">
        <motion.div 
          ...
          className="w-12 h-12 bg-primary bg-opacity-10 rounded-full grid place-items-center relative"
        >
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col items-center">
        <motion.div 
          ...
          className="w-12 h-12 bg-secondary rounded-full grid place-items-center relative"
        >
